...
var a = arr.reduce(function(prev,now,index,self){
...
var a2 = arr2.reduce(function(prev,now,index,self){
...
var a3 = arr3.reduce(function(prev,now,index,self){
...
var a4 = arr4.reduce(function(prev,now,index,self){
...
var sum = arr5.reduce(function(prev,now,index,self){
    return prev + now;
});
console.log(sum); // 150
...
var sum = arr6.reduce(function(prev,now,index,self){
    return prev + now;
},8);
console.log(sum); // 158